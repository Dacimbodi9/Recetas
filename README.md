...
This project is not yet available for download in Google Play Store or Apple App Store. However, you can download the APK file and install it on your Android device from this [github repository](https://github.com/Dacimbodi9/Recetas/releases).
